  ...
  return (
    <div className="px-4 pt-4 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-white dark:bg-[#1E2320] rounded-2xl p-4 border border-black/5 dark:border-white/5 text-center">
        ...
        <div className="bg-[#5B7A5F] text-white rounded-2xl p-4 text-center">
      ...
      <div className="bg-white dark:bg-[#1E2320] rounded-[24px] p-5 border border-black/5 dark:border-white/5">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs bg-[#F5EBDD] dark:bg-white/10 px-2.5 py-1 rounded-full font-medium">Intentional minutes</span>
        </div>
              ...
              <div key={d.key} className="flex-1 flex flex-col items-center gap-2">
                <div className="w-full flex justify-center" style={{ height: '100px' }}>
                  <div className="w-full max-w-[44px] bg-black/5 dark:bg-white/10 rounded-full relative overflow-hidden flex items-end">
                    <div className={`w-full rounded-full transition-all ${isToday ? 'bg-[#5B7A5F]' : 'bg-[#7A9E7E]'} `} style={{ height: `${h}%` }} />
                  </div>
                </div>
                <span className={`text-xs font-medium ${isToday ? 'text-[#5B7A5F] font-bold' : 'text-stone-500'}`}>{d.label}</span>
              ...
              return (
                <div key={c} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-2 bg-black/5 dark:bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-[#5B7A5F]" style={{ width: `${pct}%` }} />
                  </div>
      ...
      <div className="bg-[#FDF8F1] dark:bg-white/5 rounded-2xl p-4 border border-dashed border-black/10 dark:border-white/10 text-xs leading-relaxed text-stone-600 dark:text-white/60">
