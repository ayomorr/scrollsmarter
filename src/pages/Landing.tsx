...
function Logo() {
  return (
    <div className="flex items-center gap-2.5">
      <div className="w-9 h-9 rounded-xl bg-[#FF4F87] grid place-items-center shadow-sm">
      ...
      <span className="hidden sm:inline text-[10px] tracking-[0.12em] uppercase bg-[#FF4F87] text-white px-1.5 py-0.5 rounded-full font-bold">PWA</span>
    </div>
  )
}
...
function InstallButton({ variant='primary', className='' }: { variant?: 'primary'|'ghost'|'dark', className?: string }) {
  ...
  if (variant==='dark') return (
    <button onClick={handle} className={`inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#17152B] dark:bg-white text-white dark:text-[#17152B] font-semibold text-sm shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:opacity-90 transition min-h-[44px] ${className}`}>
  ...
  return (
    <button onClick={handle} className={`inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#FF4F87] text-white font-semibold text-[15px] shadow-[0_8px_20px_rgba(91,122,95,0.35)] hover:bg-[#E13C71] transition min-h-[44px] ${className}`}>
      Install Scroll Guard
...
function PhoneMock() {
  return (
    <div className="relative mx-auto w-[300px] md:w-[340px]">
      <div className="absolute inset-0 bg-gradient-to-b from-[#25D9D1]/20 to-[#D9FF5F]/20 blur-[40px] rounded-[40px]" />
      <div className="relative bg-[#0F1410] rounded-[46px] p-3 shadow-[0_30px_80px_rgba(0,0,0,0.25),0_0_0_1px_rgba(255,255,255,0.08)] border border-white/10">
        <div className="bg-[#FFF7F3] rounded-[34px] overflow-hidden relative">
          ...
          <div className="px-5 pb-5">
            <div className="flex items-center justify-between">
              <div className="text-[11px] tracking-widest uppercase font-bold text-[#FF4F87]">Today</div>
            ...
            <div className="mt-4 h-2 bg-black/5 rounded-full overflow-hidden">
              <div className="h-full w-[38%] bg-[#FF4F87] rounded-full" />
            </div>
            ...
            <div className="mt-4 bg-white rounded-[20px] p-4 border border-black/[0.06] shadow-sm">
              ...
              <div className="mt-2 flex items-baseline gap-2">
                ...
                <span className="text-xs bg-[#F0DFDA] px-2 py-1 rounded-full font-medium">Social • 15m</span>
              </div>
              <div className="text-xs text-stone-500">Purpose: catch up quickly</div>
              <div className="mt-3 flex gap-2">
                <span className="flex-1 py-2 rounded-full bg-[#17152B] text-white text-xs font-semibold grid place-items-center">Pause</span>
                <span className="flex-1 py-2 rounded-full bg-[#F0DFDA] text-xs font-semibold grid place-items-center">+5 min</span>
              </div>
            </div>
            ...
            <button className="mt-4 w-full py-3 rounded-full bg-[#FF4F87] text-white font-semibold text-sm">Start session</button>
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF7F3] dark:bg-[#17152B] text-[#17152B] dark:text-[#FFF7F3] selection:bg-[#FF4F87]/20">
      <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 bg-[#17152B] text-white px-4 py-2 rounded-full text-sm z-50">Skip to content</a>
      {/* NAV */}
      <header className="sticky top-0 z-30 bg-[#FFF7F3]/80 dark:bg-[#17152B]/80 backdrop-blur-xl border-b border-black/[0.06] dark:border-white/5">
        <div className="max-w-[1120px] mx-auto px-4 md:px-6 h-[64px] flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-stone-600 dark:text-white/70">
            <a href="#how" className="hover:text-[#17152B] dark:hover:text-white">How it works</a>
            <a href="#demo" className="hover:text-[#17152B] dark:hover:text-white">Demo</a>
            <a href="#features" className="hover:text-[#17152B] dark:hover:text-white">Features</a>
            <a href="#faq" className="hover:text-[#17152B] dark:hover:text-white">FAQ</a>
          </nav>
          <div className="flex items-center gap-2">
            ...
            <Link to="/app" className="md:hidden px-4 py-2 rounded-full bg-[#17152B] dark:bg-white text-white dark:text-black text-sm font-semibold">Open</Link>
          </div>
        </div>
      </header>
        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-8 md:gap-10 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-full pl-1 pr-3 py-1">
              ...
              <span className="hidden sm:inline w-6 h-6 rounded-full bg-[#17152B] text-white grid place-items-center text-xs">→</span>
            </div>
            <h1 className="font-display text-[38px] md:text-[56px] leading-[0.95] tracking-[-0.03em] mt-5">
              Take back <br />
              <span className="text-[#FF4F87] italic font-light">your scroll.</span>
            </h1>
            ...
            <div className="mt-8 flex items-center gap-3">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-[#E9D5C8] border-2 border-white dark:border-[#17152B] grid place-items-center text-xs">A</div>
                <div className="w-8 h-8 rounded-full bg-[#C8D9E9] border-2 border-white dark:border-[#17152B] grid place-items-center text-xs">B</div>
                <div className="w-8 h-8 rounded-full bg-[#D5E9C8] border-2 border-white dark:border-[#17152B] grid place-items-center text-xs">C</div>
              </div>
          ...
          <div className="relative">
            <PhoneMock />
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white dark:bg-[#26213B] rounded-2xl shadow-[0_12px_32px_rgba(0,0,0,0.12)] border border-black/5 dark:border-white/10 px-4 py-3 flex items-center gap-3 w-[92%] max-w-[360px]">
              <div className="w-10 h-10 rounded-xl bg-[#F0DFDA] grid place-items-center">⏳</div>
              <div className="flex-1">
                <div className="text-xs font-bold tracking-widest uppercase text-[#FF4F87]">Gentle reminder</div>
                <div className="text-sm font-medium leading-tight">Still want to keep scrolling?</div>
              </div>
              <div className="w-8 h-8 rounded-full bg-[#17152B] text-white grid place-items-center text-sm">›</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1120px] mx-auto px-4 md:px-6 py-10 md:py-16">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-1">
            <div className="text-xs font-bold tracking-[0.16em] uppercase text-[#FF4F87]">The problem</div>
          ...
          <div className="md:col-span-2 grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={c.title} className="bg-white dark:bg-white/[0.04] rounded-[20px] p-5 border border-black/5 dark:border-white/5">
                <div className="w-10 h-10 rounded-xl bg-[#FFF7F3] dark:bg-white/5 border border-black/5 grid place-items-center text-lg">{c.icon}</div>
        ...
        <div className="mt-6 bg-[#17152B] dark:bg-[#26213B] rounded-[24px] p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center gap-6 text-white overflow-hidden relative">
          <div className="absolute inset-0 bg-gradient-to-br from-[#FF4F87]/30 to-transparent" />
          ...
          <div className="relative bg-white text-[#17152B] rounded-full px-5 py-2.5 text-sm font-semibold">Supportive, not punitive →</div>
        </div>
      </section>
      ...
      <section id="how" className="max-w-[1120px] mx-auto px-4 md:px-6 py-6">
        <div className="text-center max-w-[640px] mx-auto">
          <div className="text-xs font-bold tracking-[0.16em] uppercase text-[#FF4F87]">How it works</div>
        ...
        <div className="grid md:grid-cols-3 gap-5 mt-8">
          {[
            { n:'01', t:'Set an intention', d:'“Catch up for 10 minutes” beats “just a sec”. Pick a purpose and a duration that feels kind.', col:'bg-[#F0DFDA]' },
            { n:'02', t:'Stay with a timer', d:'A quiet countdown lives with you. Pause anytime. Add 5 minutes if you choose to — consciously.', col:'bg-[#DFF8F5]' },
            ...
            <div key={s.n} className="bg-white dark:bg-white/[0.04] rounded-[24px] p-6 border border-black/5 dark:border-white/5 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-xs font-bold tracking-widest text-[#FF4F87]">{s.n}</div>
      ...
      <section id="demo" className="max-w-[1120px] mx-auto px-4 md:px-6 py-10 md:py-14">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 items-start">
          <div>
            <div className="inline-flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-[#FF4F87] bg-white dark:bg-white/5 border border-black/5 px-3 py-1 rounded-full">Interactive demo</div>
            ...
            <ul className="mt-6 space-y-3 text-sm">
              {[
                ...
                <li key={x} className="flex gap-2.5">
                  <span className="w-6 h-6 rounded-full bg-[#DFF8F5] dark:bg-[#FF4F87]/20 grid place-items-center text-[#FF4F87] text-xs">✓</span>
                  <span className="text-stone-700 dark:text-white/80">{x}</span>
                </li>
              ))}
            </ul>
            <div className="mt-6 hidden lg:flex gap-3">
              <Link to="/app" className="px-6 py-3 rounded-full bg-[#FF4F87] text-white font-semibold text-sm">Open the real app</Link>
      ...
      <section id="features" className="max-w-[1120px] mx-auto px-4 md:px-6 pb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-6">
              {[
                ...
                <div key={f.t} className="flex gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#F0DFDA] dark:bg-white/5 grid place-items-center text-sm shrink-0">{f.i}</div>
                  <div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-4">
          {[
            ...
            <div key={x.k} className="bg-[#FFF7F3] dark:bg-white/[0.02] rounded-2xl p-5 border border-black/5 dark:border-white/5">
              <div className="text-xs font-bold tracking-widest uppercase text-[#FF4F87]">{x.k}</div>
      ...
      <section id="install" className="max-w-[1120px] mx-auto px-4 md:px-6 py-8">
        <div className="bg-white dark:bg-[#26213B] rounded-[28px] border border-black/5 dark:border-white/10 p-6 md:p-10 overflow-hidden relative">
          <div className="absolute inset-0 bg-gradient-to-br from-[#F0DFDA]/60 via-transparent to-[#DFF8F5]/40 dark:from-white/[0.04] pointer-events-none" />
          <div className="relative grid lg:grid-cols-[1.1fr_0.9fr] gap-8 items-center">
            <div>
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-3">
                <div className="rounded-2xl bg-[#FFF7F3] dark:bg-white/5 border border-black/5 dark:border-white/10 p-4">
            ...
            <div className="relative">
              <div className="bg-[#17152B] rounded-[24px] p-6 text-white overflow-hidden relative">
                <div className="absolute -right-10 -top-10 w-40 h-40 bg-[#FF4F87]/30 blur-2xl rounded-full" />
                <div className="relative">
                  <div className="text-xs tracking-widest uppercase opacity-60 font-bold">How to install</div>
                  <ol className="mt-4 space-y-4">
                    <li className="flex gap-3">
                      <span className="w-7 h-7 rounded-full bg-white text-[#17152B] grid place-items-center text-sm font-bold shrink-0">1</span>
                    ...
                    <li className="flex gap-3">
                      <span className="w-7 h-7 rounded-full bg-white text-[#17152B] grid place-items-center text-sm font-bold shrink-0">2</span>
                      <span className="text-sm leading-relaxed">Confirm <b>Add to Home Screen</b>. Look for the leaf icon — that’s Scroll Guard.</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="w-7 h-7 rounded-full bg-white text-[#17152B] grid place-items-center text-sm font-bold shrink-0">3</span>
                  ...
                  <button onClick={()=> canInstall? prompt() : document.getElementById('install')?.scrollIntoView()} className="mt-6 w-full py-3 rounded-full bg-white text-[#17152B] font-semibold flex items-center justify-center gap-2">
          ...
          {[
            ...
            <div key={f.q} className="">
              <button onClick={()=> setFaq(faq===i ? null : i)} className="w-full text-left px-5 md:px-6 py-4 flex items-start justify-between gap-4 hover:bg-black/[0.02] dark:hover:bg-white/[0.03] transition">
                ...
                <span className={`w-7 h-7 rounded-full border grid place-items-center shrink-0 text-sm transition ${faq===i ? 'bg-[#17152B] text-white dark:bg-white dark:text-black border-transparent' : 'border-black/10 dark:border-white/10'}`}>{faq===i ? '−' : '+'}</span>
              </button>
